...
- [x] `HELP.md` holds any setup or data scripts (per the assignment's instruction).
- [x] curl samples (and/or a Postman collection) exercise all five endpoints including the error cases.
- [x] A reviewer can clone, `docker compose up -d`, run, and reproduce a transfer + cancel from the docs alone.
